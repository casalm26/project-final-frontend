import{R as v,j as e,p as y,d as r,L as z,q as L}from"./index-Bdj1OuIn.js";import{H as w}from"./TreeDetailModal-DlGV0532.js";const C=v.forwardRef(({loading:o,loadingText:i="Loading...",children:n,...x},g)=>e.jsx(y,{ref:g,loading:o,...x,children:o?i:n}));C.displayName="LoadingButton";r.span`
...
`,c=r.div`
  ...
  font-weight: 600;
  color: #111827;
`,K=({tree:o})=>e.jsxs(G,{children:[e.jsxs(f,{children:[e.jsx(u,{children:"Location"}),e.jsxs(j,{children:[e.jsxs(s,{children:[e.jsx(l,{children:"Latitude"}),e.jsx(c,{children:o.lat.toFixed(6)})]}),e.jsxs(s,{children:[e.jsx(l,{children:"Longitude"}),e.jsx(c,{children:o.lng.toFixed(6)})]})]})]}),e.jsxs(f,{children:[e.jsx(u,{children:"Contract Details"}),e.jsxs(j,{children:[e.jsxs(s,{children:[e.jsx(l,{children:"Status"}),e.jsx(c,{children:e.jsx("span",{className:"px-2 py-1 bg-green-100 text-green-800 rounded-full text-xs",children:"Active"})})]}),e.jsxs(s,{children:[e.jsx(l,{children:"Last Inspection"}),e.jsx(c,{children:"Jan 15, 2024"})]})]})]})]}),P=r.div`
  background: white;
  border-radius: 0.75rem;
  padding: 2rem;
  box-shadow: 0 1px 3px 0 rgba(0, 0, 0, 0.1);
...
`,h=r.th`
  ...
  font-weight: 600;
  color: #374151;
`,Q=({measurements:o})=>e.jsxs(P,{children:[e.jsx(W,{children:"Measurement History"}),e.jsxs(O,{children:[e.jsx(F,{children:e.jsxs(k,{children:[e.jsx(h,{children:"Date"}),e.jsx(h,{children:"Height (m)"}),e.jsx(h,{children:"Diameter (cm)"}),e.jsx(h,{children:"Health"})]})}),e.jsx("tbody",{children:o.slice(0,10).map((i,n)=>e.jsxs(k,{children:[e.jsx(m,{children:L(i.date)}),e.jsx(m,{children:i.height}),e.jsx(m,{children:i.diameter}),e.jsx(m,{children:e.jsx(w,{health:i.health,children:i.health})})]},n))})]})]}),X=r.div`
  min-height: 100vh;
