        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <Link 
                to="/register" 
                className="bg-green-600 text-white px-6 py-3 rounded-lg text-lg font-semibold hover:bg-green-700 transition-colors inline-block"
              >
                Join Nanwa Today
              </Link>
            </div>
            <div className="bg-green-50 p-8 rounded-xl">
              <div className="grid grid-cols-2 gap-4">
                <div className="text-center">
                  ...
                  <div className="text-gray-600">Trees Monitored</div>
                </div>
                <div className="text-center">
                ...
                <div className="text-center">
                  ...
                  <div className="text-gray-600">Forest Projects</div>
                </div>
                <div className="text-center">
